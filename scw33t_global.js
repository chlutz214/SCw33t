      ...
      if (foundIt === 0) { // If foundIt = 0, page is not ready to execute the following code, loop again
        ...
        //alert($("table.list tr.dataRow").length +" - "+ FIAHold);
          ...
          if (foundIt) {
						...
						$(".list").unbind("DOMNodeInserted DOMNodeRemoved DOMNodeRemovedFromDocument DOMNodeInsertedIntoDocument")
							...
							$('.dataRow').each(
								function() {
									if (eo % 2 == 0) {
										//console.log('eo: ' + eo);
										this.className = "dataRow even";
									} else {
										this.className = "dataRow odd";
									}
									eo++;
								}
							);
